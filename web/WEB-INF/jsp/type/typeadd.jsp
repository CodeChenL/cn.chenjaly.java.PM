...
<form action="${ctx}/typeaddsave.action" id="userForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">类别名称：<input type="text" name="name" id="name" size="20"/></td>
		    		</tr>
