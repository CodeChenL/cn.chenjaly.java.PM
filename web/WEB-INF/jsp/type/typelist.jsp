...
<script type="text/javascript">
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#deptform").attr("action", "${ctx}/typelist.action");
		$("#deptform").submit();
	}
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			   alert("请选择一个需要删除的类别！");
 			    ...
 			    $("#deptform").attr("action", "${ctx}/typedel.action");
 		 		$("#deptform").submit();
 		   }
 	   })
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img
				src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：类别管理
				&gt; 类别查询</td>
			<td width="15" height="32"><img
						...
						<tr>
							<td class="fftd">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">
											类别名称：<input type="text" name="name"><input
						...
						<c:forEach items="${requestScope.typelist}" var="type"
							...
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/viewtype.action?id=${type.id }"> <img
