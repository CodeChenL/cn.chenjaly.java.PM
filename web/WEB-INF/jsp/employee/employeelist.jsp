    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            /*  $("#query").click(function(){
                alert("请选择一个需要删除的员工！11111");
                    $("#empform").attr("action", "
            ${ctx}/employeelist.action");
 		 	$("#empform").submit();
 	   }) */
                                    ...
                                    <td class="font3">
                                        ...
                                        <select name="job_id" style="width:143px;">
                                            ...
                                            <c:forEach items="${requestScope.jobList}" var="job">
                                                <c:choose>
                                                    <c:when test="${job.id==employee.jobId}">
                                                        <option value="${job.id}"
                                                                selected="selected">${job.name}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                        ...
                                        身份证号码：<input type="text" name="cardId" value="${employee.cardId }"
                                                     maxlength="18">
                                    </td>
                                </tr>
                                <tr>
                ...
                <table width="100%" border="1" cellpadding="5" cellspacing="0"
                    ...
                    <c:forEach items="${requestScope.employeelist}" var="employee" varStatus="stat">
                        <tr id="data_${stat.index}" class="main_trbg" align="center">
                            <td><input type="checkbox" name="id" id="box_${stat.index}" value="${employee.id}"></td>
                            <td>${employee.name }</td>
                            <td>
                                <c:choose>
                            ...
                            <td align="center" width="40px;"><a
                                    href="${ctx}/viewEmployee.action?flag=1&id=${employee.id}">
