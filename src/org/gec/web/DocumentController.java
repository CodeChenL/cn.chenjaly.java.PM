 ...
 */
@WebServlet(urlPatterns = {"/documentlist.action", "/documentsearch.action", "/documentaddsave.action", "/documentadd.action", "/removeDocument.action", "/updateDocumentsave.action", "/updateDocument.action", "/documentdownloads.action"})
@MultipartConfig
