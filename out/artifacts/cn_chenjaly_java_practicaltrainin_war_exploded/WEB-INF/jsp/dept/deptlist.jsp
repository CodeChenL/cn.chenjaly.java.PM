...
<head>
    ...
    <script type="text/javascript">
        ...
        function toPage(pageIndex) {
            ...
            $("#userform").attr("action", "${ctx}/deptlist.action");
            $("#userform").submit();
        }
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10"
                    ...
                    <tr>
                        <td class="fftd">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">名字：<input type="text" name="name"
                                                                value="${dept.name}"/>&nbsp;&nbsp;部门：<input
                                            type="text" name="remark" value="${dept.remark}"/>
                                        <input type="button" value="查询" id="query"/><input type="button"
                                                                                           value="删除" id="delete"/>
                                    </td>
                                </tr>
                            </table>
