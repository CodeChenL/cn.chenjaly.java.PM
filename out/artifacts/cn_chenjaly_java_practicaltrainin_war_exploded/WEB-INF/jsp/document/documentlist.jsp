	...
	<script type="text/javascript">
	    $(function(){
	    	...
	    	$("a[id^='down_']").click(function(){
	    		...
	    		/** 下载该文档 */
	    		window.location = "${ctx}/documentdownloads.action?id="+id;
	    	})
		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.documentlist}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox"  id="box_${stat.index}" value="${document.id} " name="docId" ></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/updateDocumentsave.action?flag=1&id=${document.id}">
