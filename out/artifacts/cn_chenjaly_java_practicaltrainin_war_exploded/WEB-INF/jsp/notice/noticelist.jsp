...
<script type="text/javascript">
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#userform").attr("action", "${ctx}/noticelist.action");
		$("#userform").submit();
	}
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			   alert("请选择一个需要删除的公告！");
 			    ...
 			    $("#userform").attr("action", "${ctx}/noticedel.action");
 		 		$("#userform").submit();
 		   }
 	   })
		    ...
		    <tr>
			  <td class="fftd">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
					    <td class="font3">
					    	标题：<input type="text" name="title" value="${notices.title }">
						...
						<c:forEach items="${requestScope.noticelist}" var="notice"
							...
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/displayNotice.action?id=${notice.id }"> <img
										title="展示" src="${ctx}/images/update.gif" /></a></td>
								<td align="center" width="40px;"><a
